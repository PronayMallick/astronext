        ...
        <div className="flex border rounded-md flex-col w-full bg-slate-50 mt-2 ">
            ...
            <div className=' w-56 h-20 flex relative'>
                ...
                <div className='relative'>
                    {/* {cardSelect} */}
                    <button id='dispCard' className=' py-2 px-3 rounded-lg text-sm bg-red-600' onClick={() => displayCard() }> {(cardLeft < 1) ? "Show my reading" : cards ? "Choose "+ cardLeft +" more cards" : "select 3 cards"}</button>
                </div>           
            </div>
